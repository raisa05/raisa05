...
[//]: # (You must have a lf before the markdown element when inside a block for it to work)
 ...
 *
 * @constructor
 * @param {string} name - Raisa Anvar Raseena.
 * @param {string} location - Dubai, UAE.
 * @param {string} languages - English, Hindi, Arabic, Malayalam.
 * @param {string} currentRole - Final Year Computer Science Student.
 * @param {string} education - BSc Computer Science, University of Birmingham Dubai.
 * @param {string} specialization - AI/ML, Data Science.
 * @param {string} currentWork - Traffic Control using GNNs, Collaborative Learning Platforms.
 * @param {string} leadership - Founder & Lead of Google Developers Group on Campus at UOBD.
 * @param {string} approachable - Absolutely! Open to collaborate on innovative projects.
 * @param {string} strength - Strategic thinking, Problem-solving & Adaptability.
 * @param {string} mission - Leveraging technology to solve real-world challenges.
 *
 * @throws {Innovation} At complex problems with AI-driven solutions.
 *
 * @returns {Object} Raisa - A passionate technologist and community builder.
 */
```
...
<div>
  <p style="display: inline-block;" align="center">
    ...
    <kbd>
      ...
      <img width="30px" src="https://www.vectorlogo.zone/logos/microsoft_powerbi/microsoft_powerbi-icon.svg" alt="powerbi" title="Power BI"/>
      <img width="30px" src="https://miro.medium.com/v2/resize:fit:300/1*R4c8lHBHuH5qyqOtZb3h-w.png" alt="balsamiq" title="Balsamiq"/>
...
<details>
  ...
  - Scalable traffic optimization systems using Graph Neural Networks
  - Deep Reinforcement Learning applications
  - Full-stack collaborative learning platforms
...
<div align=center>
 <a href="https://www.linkedin.com/in/raisaanvar" target="_blank"><img src="https://img.shields.io/static/v1?style=for-the-badge&message=LinkedIn&color=0A66C2&logo=LinkedIn&logoColor=FFFFFF&label=" alt="LinkedIn" /></a>
<a href="mailto:raisaanvar05@gmail.com?subject=Hi%20Raisa,%20nice%20to%20meet%20you!" target="_blank"><img alt="Email" src="https://img.shields.io/static/v1?style=for-the-badge&message=Gmail&color=EA4335&logo=Gmail&logoColor=FFFFFF&label=" /></a>
<a href="https://github.com/raisa05" target="_blank"><img src="https://img.shields.io/static/v1?style=for-the-badge&message=GitHub&color=181717&logo=GitHub&logoColor=FFFFFF&label=" alt="GitHub" /></a>
</div>
